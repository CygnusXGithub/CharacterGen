...
│   ├── state/
│   │   ├── __init__.py
│   │   ├── base.py        # StateManagerBase
│   │   ├── character.py   # CharacterStateManager
│   │   ├── ui.py         # UIStateManager
...
│   │   ├── generation.py  # Generation-related models
│   │   ├── ui.py         # UI state models
...
│   │   └── editor.py    # Character editor window
│   │
│   └── styles/
│       ├── __init__.py
